...
public class signup {
    ...
    void registerUser() throws IOException {
        ...
        TextField us = (TextField) scene.lookup("#username"); // recupero lo username
        String username = us.getText();
        PasswordField ps = (PasswordField) scene.lookup("#password"); // recupero lo username
        String password = ps.getText();
        TextField n = (TextField) scene.lookup("#name"); // recupero lo username
        String name = n.getText();
        TextField s = (TextField) scene.lookup("#surname"); // recupero lo username
        String surname = s.getText();
        TextField a = (TextField) scene.lookup("#age"); // recupero lo username
